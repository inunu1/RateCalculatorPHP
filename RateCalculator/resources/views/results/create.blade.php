<x-app-layout>
    ...
    <form action="{{ route('player.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="winner_id" name="winner_id" value="{{ old('winner_id') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="loser_id" name="loser_id" value="{{ old('loser_id') }}"
                           class="border border-gray-300 p-2 rounded px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                           min="1" step="1" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" id="game_date" name="game_date" value="{{ old('game_date', \Carbon\Carbon::now()->format('Y-m-d\TH:i')) }}"
                        class="border border-gray-300 p-2 rounded px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
